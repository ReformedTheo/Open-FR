    ...
    def run_recognition(self):
        ...
        while True:
            ...
            if self.proccess_current_frame:
                ...
                self.face_encondings = face_recognition.face_encodings(rgb_small_frame, self.face_locations)

                self.face_names = []
                for face_encoding in self.face_encondings:
